...
overlapping moving window patch（256*256） prediction to mosaic into large mask
@author: Ce Zhang
"""

from model import unet, segnet_vgg16, fcn_vgg16_8s, fcn_2s, VGGUnet2, res_unet1, D_resunet1
...
fileDir = "data/flower/test/images"  #test images(1024*1024)
#fileDir = "data/flower/train/f"
preDir = "data/flower/test/sub_test/predict/" #Dir of predict mask
